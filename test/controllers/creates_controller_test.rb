...
class CreatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create create" do
    assert_difference('Create.count') do
      post creates_url, params: { create: { Event: @create.Event, date: @create.date, description: @create.description, location: @create.location, title: @create.title } }
    end
  ...
  test "should update create" do
    patch create_url(@create), params: { create: { Event: @create.Event, date: @create.date, description: @create.description, location: @create.location, title: @create.title } }
